...
abstract final class AppColors {
  ...
  static const Color exito = Color(0xFF1F5E1F);
  static const Color fondoExito = Color(0xFFE7F5E7);

  static const Color advertencia = Color(0xFF8A5A00);
  static const Color fondoAdvertencia = Color(0xFFFFF0C2);

  static const Color error = Color(0xFFB3261E);
  static const Color fondoError = Color(0xFFFFE5E2);
}